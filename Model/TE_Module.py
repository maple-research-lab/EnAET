...
class TE_Module(nn.Module):
    ...
    """
    def __init__(self, _num_inchannels=3,num_classes=10, _num_stages=3, _use_avg_on_conv3=True,run_type=0):
        ...
        blocks[-1].add_module('Linear',nn.Linear(nChannels, num_classes))
